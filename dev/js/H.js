...
* http://jqueryui.com
* Includes: core.js, widget.js, mouse.js, position.js, sortable.js, datepicker.js, menu.js, selectmenu.js, slider.js
...
$.Widget.prototype = {
	...
	_trigger: function( type, event, data ) {
		...
		return !( $.isFunction( callback ) &&
			...
			!this.isLtIE8 && event.isDefaultPrevented() ); //edit by czf
	}
};
